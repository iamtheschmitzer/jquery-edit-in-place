...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<button class="btn btn-success btn-small">Save</button>', // string: image button tag to use as “Save” button
	cancel_button:		'<button class="btn btn-warning btn-small">Cancel</button>', // string: image button tag to use as “Cancel” button
